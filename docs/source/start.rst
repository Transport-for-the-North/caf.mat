...
*CAF.mat is provided as a Python package and a command-line utility.
...
CAF.mat can be installed from pip, conda-forge or **pipx
...
``conda install caf.mat -c conda-forge``

Pipx
----

.. todo::
    Does CAF.mat support being installed with
...
.. todo::
    Does CAF.mat have a CLI or GUI?
...
.. todo::
    Does CAF.mat have a suggested alias?

When using CAF.mat functionality within Python:
